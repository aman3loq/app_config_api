...
# restplus swagger-ui
api = Api(app, version='1.0', title='swagger for app configuration UI',
          description='A swagger-ui for app-config page',
          default='Configuration UI', default_label='RESTful API services for Configuration UI')

# Flask app configurations
app.config['SQLALCHEMY_BINDS'] = {
                                    'bind_db': config['db']['db_url']
                                 }
